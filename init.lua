  ...
  { "folke/which-key.nvim", opts = {} },
  {
    ...
    opts = {
      ...
      on_attach = function(bufnr)
        ...
        map({ "n", "v" }, "hs", ":Gitsigns stage_hunk | update<CR>", "[hs] Stage Hunk")
        map({ "n", "v" }, "hS", function()
          gs.stage_buffer()
          vim.cmd("w")
        end, "[hS] Stage Buffer")
        map({ "n", "v" }, "hu", gs.undo_stage_hunk, "[hu] Undo Stage Hunk")
        map({ "n", "v" }, "hr", ":Gitsigns reset_hunk | update<CR>", "[hr] Reset Hunk")
        map({ "n", "v" }, "hR", function()
          gs.reset_buffer()
          vim.cmd("w")
        end, "[hR] Reset Buffer")
